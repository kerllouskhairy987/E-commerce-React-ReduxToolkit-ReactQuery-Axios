...
const ErrorHandler = ({ statusCode = 500, title = "Internal Server ERROR" }: IProps) => {
    ...
    return (
        <div className="flex justify-center items-center min-h-[100vh] flex-col text-center">
            ...
            <h2 className="text-5xl font-bold my-10 text-white">{statusCode} - {title}</h2>
            <p className="text-lg font-medium text-white">Oops something went wrong, Try to refresh this page or feel free to content us if this problem still</p>
